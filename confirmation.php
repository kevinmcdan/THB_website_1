...
if(isset($_GET['tx']))
{
  ...
  $result = process_pdt($tx);
    ...
    if ($result){
        ...
        We will be contacting you shortly to send you the relevant questionnaire for the tour you applied for, and to get to know a little bit what you\'re looking for on your new Tokyo adventure. Your tour is extremely special to us!!
...
function process_pdt($tx)
{
        ...
        (
                ...
                (
                        'cmd' => '_notify-synch',
                        'tx' => $tx,
                        'at' => 'tq-UDDMmR1xifWNDdiez-mP9-J0JgL_tILSOjCI-nsoII8dtkJdbbKFibSa',
                )),
...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="Confirmation of Reservation">	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0' name='viewport'">
	...
	<title>Tokyo Handsome Boys Japan Tours | Confirmation</title>
